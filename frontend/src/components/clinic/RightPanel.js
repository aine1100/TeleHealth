...
const RightPanel = ({ appointments, invites }) => {
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-ink-200/70 bg-white p-5 shadow-card">
        ...
        <p className="mt-1 text-sm font-semibold text-ink-900">31 of 48 served today</p>
          ...
          {appointments.map((item) => (
            <div key={item.id} className="flex items-center gap-3">
              ...
              <div className="text-right">
                <p className="text-[11px] text-ink-400">{item.meta}</p>
