    ...
    <div className="mx-auto max-w-[1500px] animate-fade-up">
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-ink-500">Your personal consult calendar.</p>
        </div>
        <button
          type="button"
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="truncate text-[11px] text-ink-500">{style.label}</p>
                      </div>
                    ...
                    >
                      ...
                      <p
                        className={`mx-auto mt-1 flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold ${
                          today || selected ? 'bg-brand-500 text-white' : 'text-ink-800'
                        }`}
                      >
                        {format(day, 'd')}
                      </p>
              ...
              <div className="relative grid grid-cols-[64px_repeat(7,minmax(0,1fr))]">
                ...
                {weekDays.map((day) => {
                  ...
                  return (
                    <div
                      key={key}
                      className={`relative border-l border-ink-100 ${isSameDay(day, selectedDate) ? 'bg-brand-50/20' : ''}`}
                    ...
                    >
                      ...
                      {dayAppts.map((appt) => {
                        ...
                        return (
                          ...
                          >
                            <p className="truncate text-[11px] font-bold leading-tight">{getPatientName(appt)}</p>
